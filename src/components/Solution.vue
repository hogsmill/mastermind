<template>
  <div class="col">
    <div class="row solution rounded">
      ...
      <div v-if="host" class="col">
        <button class="btn btn-info btn-sm" @click="clear()">
          Clear
        </button>
      </div>
      <div class="col">
        <button class="btn btn-info btn-sm" @click="newGame()">
          New Game
        </button>
      </div>
      <div v-if="host || lost" class="col item" :class="getClass(solution1)" @click="setSolution1($event)" />
      <div v-if="host || lost" class="col item" :class="getClass(solution2)" @click="setSolution2($event)" />
      <div v-if="host || lost" class="col item" :class="getClass(solution3)" @click="setSolution3($event)" />
      <div v-if="host || lost" class="col item" :class="getClass(solution4)" @click="setSolution4($event)" />
    </div>
  </div>
</template>
